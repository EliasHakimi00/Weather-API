...
This is the Challenge for Week 8 of the Bootcamp. This challenge allowed me to learn more APIs and how to get API keys set up. It also gave me an opportunity to brush up on some existing css and html knowledge to consolidate my overall understanding. 

The link for the deployed site is:
https://eliashakimi00.github.io/Weather-API/

Here are some screenshots of the deployed site:
![portfolio demo](./assets/Screenshot%202023-03-18%20at%2022.54.15.png)
